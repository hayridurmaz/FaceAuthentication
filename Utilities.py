...
def create_dataset_for_user(cam, user, numberOfsamples, recognizer):
    ...
    while (True):
        ...
        faces = recognizer._Face_Cascade.detectMultiScale(gray, scaleFactor=1.098, minNeighbors=6, minSize=(50, 50))
        ...
        try:
            for _, face in enumerate(faces):
                ...
                Right_Eye = recognizer._Right_Eye_Cascade.detectMultiScale(gray[y: y + int(h / 2), x: x + int(w / 2)],
                ...
                for _, eye1 in enumerate(Right_Eye):
                    ...
                    Left_Eye = recognizer._Left_Eye_Cascade.detectMultiScale(
